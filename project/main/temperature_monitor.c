...
#include "../components/display/font8x8_basic.h"
#include "../components/sensors/DHT.h"
...
{
	setDHTgpio(TEMPERATURE_SENSOR_INPUT);
...
void app_main(void)
{
	...
	xTaskCreate(&TemperatureSensorTask, "TemperatureSensorTask", 5098, NULL, 5, NULL);
}
